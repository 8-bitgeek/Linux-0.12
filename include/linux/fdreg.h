 ...
 */
/*
 * 该文件中含有一些软盘控制器的一些定义. 这些信息有多处来源, 大多数取自 Sanches 和 Canton 编著的 <<IBM 微型计算机: 程序员手册>> 一书.
 */
...
#define ST1_OR		0x10		/* OverRun */					// 数据传输超时(DMA 控制器故障)
#define ST1_CRC		0x20		/* CRC error in data or addr */	// CRC 检验出错.
...
#define ST2_CRC		0x20		/* CRC error in data field */		// 数据场 CRC 校验错.
